...
CONFIG_FIELD_REGISTRY: dict[str, ConfigFieldMeta] = {
    ...
    "QDRANT_ENABLE_QUANTIZATION": ConfigFieldMeta("QDRANT_ENABLE_QUANTIZATION", value_type="bool"),
    "QDRANT_QUANTIZATION_TYPE": ConfigFieldMeta("QDRANT_QUANTIZATION_TYPE", value_type="enum", options=("scalar_int8",)),
    "QDRANT_FORCE_RECREATE_ON_QUANTIZATION": ConfigFieldMeta("QDRANT_FORCE_RECREATE_ON_QUANTIZATION", value_type="bool"),
    "VECTOR_FALLBACK_TO_NEO4J": ConfigFieldMeta("VECTOR_FALLBACK_TO_NEO4J", value_type="bool"),
    "NEO4J_WRITE_BATCH_SIZE": ConfigFieldMeta("NEO4J_WRITE_BATCH_SIZE", value_type="int"),
    ...
    "RAG_RETRIEVAL_CHANNEL_TIMEOUT_S": ConfigFieldMeta("RAG_RETRIEVAL_CHANNEL_TIMEOUT_S", value_type="float"),
    "RAG_CACHE_ENABLED": ConfigFieldMeta("RAG_CACHE_ENABLED", value_type="bool"),
    "RAG_RETRIEVAL_CACHE_TTL_S": ConfigFieldMeta("RAG_RETRIEVAL_CACHE_TTL_S", value_type="int"),
    "RAG_ANSWER_CACHE_TTL_S": ConfigFieldMeta("RAG_ANSWER_CACHE_TTL_S", value_type="int"),
    "RAG_RETRIEVAL_CACHE_MAX_ENTRIES": ConfigFieldMeta("RAG_RETRIEVAL_CACHE_MAX_ENTRIES", value_type="int"),
    "RAG_ANSWER_CACHE_MAX_ENTRIES": ConfigFieldMeta("RAG_ANSWER_CACHE_MAX_ENTRIES", value_type="int"),
    ...
    # Deprecated: will be removed in next minor version. Use TC_TEXT_*/TC_VISION_* instead.
    "CUSTOM_API_KEY": ConfigFieldMeta("CUSTOM_API_KEY", value_type="secret", sensitive=True, editable=False),
    "CUSTOM_BASE_URL": ConfigFieldMeta("CUSTOM_BASE_URL", editable=False),
    "CUSTOM_MODEL_NAME": ConfigFieldMeta("CUSTOM_MODEL_NAME", editable=False),
    "QWEN_API_KEY": ConfigFieldMeta("QWEN_API_KEY", value_type="secret", sensitive=True, editable=False),
    "QWEN_BASE_URL": ConfigFieldMeta("QWEN_BASE_URL", editable=False),
    "QWEN_MODEL_NAME": ConfigFieldMeta("QWEN_MODEL_NAME", editable=False),
    "DEEPSEEK_API_KEY": ConfigFieldMeta("DEEPSEEK_API_KEY", value_type="secret", sensitive=True, editable=False),
    "DEEPSEEK_BASE_URL": ConfigFieldMeta("DEEPSEEK_BASE_URL", editable=False),
    "DEEPSEEK_MODEL_NAME": ConfigFieldMeta("DEEPSEEK_MODEL_NAME", editable=False),
    # Testcase Gen slot-based credentials (new)
    "TC_TEXT_API_KEY": ConfigFieldMeta("TC_TEXT_API_KEY", value_type="secret", sensitive=True),
    "TC_TEXT_API_BASE_URL": ConfigFieldMeta("TC_TEXT_API_BASE_URL"),
    "TC_VISION_API_KEY": ConfigFieldMeta("TC_VISION_API_KEY", value_type="secret", sensitive=True),
    "TC_VISION_API_BASE_URL": ConfigFieldMeta("TC_VISION_API_BASE_URL"),
    "TC_EMBEDDING_API_KEY": ConfigFieldMeta("TC_EMBEDDING_API_KEY", value_type="secret", sensitive=True),
    "TC_EMBEDDING_API_BASE_URL": ConfigFieldMeta("TC_EMBEDDING_API_BASE_URL"),
    "TC_EMBEDDING_DIM": ConfigFieldMeta("TC_EMBEDDING_DIM", value_type="int"),
